...
There exists a wide variation in the fiscal efficiency of these systems. But understanding these financial dimensions is essential for evaluating both the sustainability and performance of transit services.
...
The data provide insights into: which systems operate most efficiently, which modes of transport generate the most revenue, and how these metrics differ throughout the United States.

Using tools from the R programming language, we explore these trends over time along with the influence of population density, geography, and mode-type on a transit system's financial outcomes. 

Through this exploration, we hope to better understand the complex relationship between transit usage, financial sustainability, and regional transit characteristics.
