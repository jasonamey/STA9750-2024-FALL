...
This dynamic remains topical as commentary last-week immediately following **Donald Trump**'s significant electoral victory led a popular Conservative commentator to remark on the conintued diminished influence of both the **Rust Belt** and the American **Northeast**, and its traditional bases of power among the **Democratic Party**^[Shapiro, B. [@benshapiro]. (2024, 11, 6). "Hey Democrats, I have some more unfortunate news for you. Here's what the electoral map looks like.. " Tweet. X. https://x.com/benshapiro/status/1854210993645297694]: 
...
![](images/mp-03/2000-electoral-systems.png){style="width:60%; border: 1px solid black; display: block; margin: 10px auto;"}

![](images/mp-03/2016-electoral-systems.png){style="width:60%; border: 1px solid black; display: block; margin: 10px auto;"}
