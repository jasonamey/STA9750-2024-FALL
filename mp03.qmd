...
# Function to download shapefiles UCLA’s PoliSci Mapping Center, 95 | 112 represents relevant 
...
# Prepare data for ggplot chart
data <- data.frame(
  Year = c(1984, 1980, 1992, 1988, 1996, 1992, 1976, 2008, 2016, 2020, 2016, 2012, 2004, 1996, 2000, 2000, 2020, 2004, 2012, 1980, 2008, 1976, 1988, 1984),
  Party = c("Democrat", "Democrat", "Democrat", "Democrat", "Republican", "Republican", "Democrat", "Democrat", "Republican", "Republican", "Democrat", "Republican", "Democrat", "Democrat", "Republican", "Democrat", "Democrat", "Republican", "Democrat", "Republican", "Republican", "Republican", "Republican", "Republican"),
  Score = c(3.12, 1.32, 1.08, 0.903, 0.794, 0.731, 0.606, 0.110, 0.0802, -0.121, -0.186, -0.203, -0.224, -0.262, -0.312, -0.374, -0.426, -0.492, -0.571, -0.661, -0.842, -1.05, -1.41, -1.60)
)
...
#### DOES NOT RENDER. IS NOT IN PROJECT :-( ####
...
print(total_votes_check)  # Should be 538
